            ...
            <el-row>
                <el-col :span="16">
                    <el-carousel :interval="4000" type="card" height="40vh">
                        <el-carousel-item v-for="img in imgs" :key="img.key" style="border-radius: .7rem;">
                            <el-image style="height: 40vh" :src="img.url"/>
                        </el-carousel-item>
                    </el-carousel>
                </el-col>
                <el-col :span="8">
                        ...
                        <div class="item item--1">
                            <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path fill="rgba(149,149,255,1)"
                                      d="M17 15.245v6.872a.5.5 0 0 1-.757.429L12 20l-4.243 2.546a.5.5 0 0 1-.757-.43v-6.87a8 8 0 1 1 10 0zm-8 1.173v3.05l3-1.8 3 1.8v-3.05A7.978 7.978 0 0 1 12 17a7.978 7.978 0 0 1-3-.582zM12 15a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"></path>
                            </svg>
                            <span class="quantity"> +{{ store.loginNum.loginNum }} </span>
                            <span class="text text--1"> 今日访问量 </span>
                        </div>
                        <div class="item item--2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                ...
                                <path d="M16 16c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zM6 12c2.21 0 4 1.79 4 4s-1.79 4-4 4-4-1.79-4-4 1.79-4 4-4zm10 6c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1zM6 14c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2-2zm8.5-12C17.538 2 20 4.462 20 7.5S17.538 13 14.5 13 9 10.538 9 7.5 11.462 2 14.5 2zm0 2C12.567 4 11 5.567 11 7.5s1.567 3.5 3.5 3.5S18 9.433 18 7.5 16.433 4 14.5 4z"
                                      fill="rgba(252,161,71,1)"></path>
                            </svg>
                            <span class="quantity"> +70 </span>
                            <span class="text text--2"> 今日文章增加量 </span>
                        </div>
                        ...
                        <div class="item item--4">
                            <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path fill="rgba(220,91,183,1)"
                                      d="M12 20h8v2h-8C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10a9.956 9.956 0 0 1-2 6h-2.708A8 8 0 1 0 12 20zm0-10a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-4 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm8 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-4 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path>
                            </svg>
...
const imgs = reactive([{
    key: '1',
    url: '../src/img/cat-thug-life-ns.jpg'
}, {
    key: '2',
    url: '../src/img/cat-thug-life-ns.jpg'
}, {
