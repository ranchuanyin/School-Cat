        ...
        <el-container>
            <div>
                <el-aside class="hidden-sm-and-down" width="auto">
                    <el-card style="margin-top: 10px;margin-left: 10px;margin-right: 10px;height: 98vh;"
                             shadow="always">
                        ...
                        <el-row style="width: 60px;" align="top">
                            <el-col style="height: 35vh;width: 0;">
                            </el-col>

                            <el-col>
                                <el-row justify="center">
                                    <el-avatar shape="square" style="background-color: white;" :size="30"
                                               src="./src/img/重.png"/>
                                </el-row>
                            </el-col>
                            ...
                            <el-col>
                                <el-row justify="center">
                                    <el-avatar shape="square" style="background-color: white;" :size="90"
                                               src="./src/img/猫(1).png"/>
                                </el-row>
                            </el-col>
                        </el-row>
            ...
            <el-container>
             ...
             -5px -5px 17px #ffffff;">
                    <el-row justify="start">
                        <el-col :span="8">
                            <iframe class="hidden-sm-and-down" width="400" height="60" frameborder="0" scrolling="no"
                                    hspace="0"
                        ...
                        <el-col :span="6" style="margin-top: 15px;">
                            <el-row justify="end">
                                ...
                                <el-col :span="4">
                                    <el-dropdown trigger="click">
                                        <el-row align="top">
                                            <svg t="1683127314362" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                 xmlns="http://www.w3.org/2000/svg" p-id="4981" width="25" height="20">
                                ...
                                <el-col :span="4">
                                    <el-dropdown trigger="click">
                                        <el-row align="top">
                                            <svg t="1683129053227" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                 xmlns="http://www.w3.org/2000/svg" p-id="15659" width="25" height="20">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card__content">
                                                ...
                                                <el-row justify="end" style="margin-right: 10px">
                                                    <el-button @click="logout()" type="danger" :icon="SwitchButton"
                                                               circle/>
                                                </el-row>
                                            </div>
                                        </div>
                ...
                <el-main style="height: 80vh;margin-right: 5px;margin-bottom: 5px;border-radius: 17px;background: #ffffff;box-shadow:  5px 5px 17px #d1d1d1,
...
onMounted(() => {
    ...
    get('/cat/count/num',(message) => {
        store.loginNum.loginNum = message
    })
})
...
const logout = () => {
    ...
    get('/cat/auth/logout', (mess) => {
        post('/cat/auth/del-redis',{
            id: id
        },(message) => {
            store.auth.user = null
            ElMessage.success(mess)
